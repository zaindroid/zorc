 ...
 */
export declare class DataBlobKey extends Message<DataBlobKey> {
  /**
 ...
 */
export declare class DataBlob extends Message<DataBlob> {
  /**
 ...
 */
export declare enum DataStream_CompressionType {
  /**
   * @generated from enum value: NONE = 0;
   */
  NONE = 0,
