...
import type { AudioCodec, ImageCodec, ParticipantInfo_Kind, TokenPagination, VideoCodec, WebhookConfig } from "./livekit_models_pb.js";
 ...
 */
export declare class StartEgressRequest extends Message<StartEgressRequest> {
  /**
 ...
 */
export declare class TemplateSource extends Message<TemplateSource> {
  /**
 ...
 */
export declare class WebSource extends Message<WebSource> {
  /**
 ...
 */
export declare class MediaSource extends Message<MediaSource> {
  /**
 ...
 */
export declare class ParticipantVideo extends Message<ParticipantVideo> {
  /**
 ...
 */
export declare class AudioConfig extends Message<AudioConfig> {
  /**
 ...
 */
export declare class AudioRoute extends Message<AudioRoute> {
  /**
 ...
 */
export declare class DataConfig extends Message<DataConfig> {
  /**
   * @generated from field: bool capture_all = 1;
   */
  captureAll: boolean;
 ...
 */
export declare class DataSelector extends Message<DataSelector> {
  /**
 ...
 */
export declare class FileOutput extends Message<FileOutput> {
  /**
 ...
 */
export declare class UpdateEgressRequest extends Message<UpdateEgressRequest> {
  /**
 ...
 */
export declare class ExportReplayRequest extends Message<ExportReplayRequest> {
  /**
